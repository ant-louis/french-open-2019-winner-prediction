...
# Read the csv file
df = pd.read_csv('../../data/original_dataset/cleaned_data_with_2019_matches.csv', header=0, index_col=0)
...
# Save dataset
df.reset_index(drop=True, inplace=True)
df.to_csv('../../data/original_dataset/preprocessed_data_with_2019_matches.csv', sep=',', encoding='utf-8', float_format='%.10f', decimal='.')
