...
# Read the csv file
df = pd.read_csv('../../data/new_stats_dataset/new_stats_data_weight06_+surface_weighting_min20matches.csv', header=0, index_col=0)
...
diff_df.to_csv('../../data/training_dataset/training_data_weight06_+surface_weighting_min20matches.csv', sep=',', encoding='utf-8', float_format='%.10f', decimal='.')
