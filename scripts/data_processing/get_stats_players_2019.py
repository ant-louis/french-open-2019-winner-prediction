...
# Read csv
df = pd.read_csv('../../data/original_dataset/preprocessed_data_with_2019_matches.csv', header=0, index_col=0)
players_df = pd.read_csv('../../data/predictions/players_2019.csv', header=0, index_col=0)
...
# Save dataset
players_df.to_csv('../../data/predictions/stats_players_2019.csv', sep=',', encoding='utf-8', float_format='%.10f', decimal='.')
