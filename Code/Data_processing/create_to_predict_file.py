...
def create_matches_file(players_stats):
    ...
    # Save dataset
    diff_df.to_csv('_Data/Predictions/to_predict_data_French_Open_2019.csv', sep=',', encoding='utf-8', float_format='%.10f', decimal='.')
...
def predict_all_matches(matches_to_predict, model_path, selected_features=None):
    ...
    prediction.to_csv('_Data/Predictions/predictions_2019_matches.csv', index=False)


if __name__ == "__main__":
    # Files
    players_stats = '_Data/Predictions/stats_players_2019.csv'
    matches_to_predict = '_Data/Predictions/to_predict_data_French_Open_2019.csv'
